...
function fetchHero():Promise<superheros[]>{
     return Promise.resolve(superheroes);
}

fetchHero().then(ele=>console.log(superheroes))
...
function fetchmobile():Promise<mobilePhones[]>{
      return Promise.resolve(mobilePhones);
} 
